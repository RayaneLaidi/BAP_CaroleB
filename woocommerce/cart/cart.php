		...
		<div class="cart-collaterals">
			...
			<div class="custom-cart-summary">
				...
				<p class="summary-subtotal">
					<span><?php esc_html_e('Sous-total', 'woocommerce'); ?></span><span><?php echo wp_kses_post($subtotal_html); ?></span>
				</p>
				<p class="summary-tax">
					<span><?php esc_html_e('TVA', 'woocommerce'); ?></span><span><?php echo wp_kses_post($tax_html); ?></span>
				</p>
				<p class="summary-total">
					<strong><?php esc_html_e('Total', 'woocommerce'); ?></strong><strong><?php echo wp_kses_post($total_html); ?></strong>
				</p>
				<a href="<?php echo esc_url($checkout_url); ?>"
					class="button checkout-button"><?php esc_html_e('Passer à l\'achat', 'woocommerce'); ?></a>
			</div>
		</div>
